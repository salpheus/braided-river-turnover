...
mstack_path = '/Volumes/SAF_Data/SAF_Data/remote-data/arrays/C02_1987-2023_allLS_db/1999_nc/'
save_path = '/Volumes/SAF_Data/SAF_Data/remote-data/arrays/C02_1987-2023_allLS_db/water_palette/'
...
for maskstack in maskstacks:
    maskstack = 'brahmaputra_pandu_allyr_masks.nc'
    rivname = maskstack.split('/')[-1].split('_masks.nc')[0] 
    
    # masks = xr.load_dataset(maskstack).masks.to_numpy()
    masks = xr.load_dataset('/Volumes/SAF_Data/SAF_Data/remote-data/arrays/C02_1987-2023_allLS_db/1999_nc/brahmaputra_pandu_allyr_masks.nc').masks.to_numpy()
